...
public class ChooseTopicQuizModifierEffect extends QuizModifierEffect {
    ...
    public ChooseTopicQuizModifierEffect(QuizModifier quizModifier, Integer duration) {
    ...
    public ChooseTopicQuizModifierEffect(QuizModifier quizModifier, Integer duration, String topic) {
    ...
    public ChooseTopicQuizModifierEffect(QuizModifier quizModifier, Integer duration, String topic, Integer tier) {
